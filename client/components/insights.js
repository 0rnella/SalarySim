...
export const Insights = props => {
    ...
    // render(){
        ...
        let sumExpenses = sum(Object.values(expenses))
        let sumDebts = sum(debts, "amount")
        return (
          <div className="col l9">
              <h1>WHoA</h1>
              <div id="overview-row">
                  <OverviewCard color={"red"} number={sumExpenses} title={"Monthly expenses"}/>
                  <OverviewCard color={"green"} number={monthlySalary} title={"Monthly salary"}/>
